...
class SessionRedisAdapterTest {
    ...
    @BeforeEach
    void setUp() {
        adapter = new SessionRedisAdapter(
                redisTemplate,
                objectMapper,
    ...
    void shouldCreateSessionSuccessfully() throws JsonProcessingException {
        ...
        AuthSessionRedisValue authSessionRedisValue = AuthSessionRedisValue.builder()
                .userId(1L)
                .role("ADMINISTRADOR")
                .numberDocument("123456")
                .phone("+573001112233")
        ...
        when(redisRequestMapper.toInsert(any()))
                .thenReturn(authSessionRedisValue);
    ...
    void shouldFindSessionByTokenSuccessfully() throws Exception {
        ...
        AuthSessionRedisValue sessionRedisValue = AuthSessionRedisValue.builder()
                .userId(1L)
                .role("ADMINISTRADOR")
                .numberDocument("123456")
                .phone("+573001112233")
        ...
        when(objectMapper.readValue(
                anyString(),
                eq(AuthSessionRedisValue.class)
        )).thenReturn(sessionRedisValue);

        when(redisRequestMapper.toDomain(any()))
                .thenReturn(session);
